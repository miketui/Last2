...
**Repo:** `miketui/Last2`  
**Preferred app path:** `apps/author-site/`
...
## TASK A — REPO AUDIT
Inspect and write `docs/website-v4/00_REPO_AUDIT.md` with:
...
### `10_IMMERSIVE_DESIGN_FORMATTING_STYLE_GUIDE.md`
Copy the root design guide into `docs/website-v4/`, then adapt it to the actual generated site. It must include:
...
### `11_BACKEND_ANALYTICS_SUBSCRIPTION_SETUP.md`
Copy the root backend guide into `docs/website-v4/`, then adapt it to the actual generated site. It must include:
...
Create a Next.js app under `apps/author-site/`.
...
grep -RIn --exclude-dir=node_modules --exclude-dir=.next \
  -E '#0E0D0B|#B89968|#1F6F6B|#2B9999|#C9A961' apps/author-site docs/website-v4 || true
