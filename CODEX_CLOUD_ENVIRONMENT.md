...
App path Codex should create: `apps/author-site/`
...
"Complete TASK A and TASK B only. Create docs/website-v4. Do not build the app yet."

### Task 2 — Scaffold app
"Using docs/website-v4 as locked source, create the Next.js app under apps/author-site. Include all pages, components, content, lib files, migrations, .env.example, README, and tests. Do not use real secrets."
