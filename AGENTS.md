...
- Site location: create the new web app under `apps/author-site/` unless a newer authoritative web app already exists.
...
## Work protocol
1. Inspect the repo and write `docs/website-v4/00_REPO_AUDIT.md`.
...
3. Scaffold or update the actual app under `apps/author-site/`.
...
- `apps/author-site/next.config.ts`
- `apps/author-site/tsconfig.json`
- `apps/author-site/tailwind.config.ts`
- `apps/author-site/postcss.config.mjs`
- `apps/author-site/middleware.ts`
- `apps/author-site/app/layout.tsx`
- `apps/author-site/app/page.tsx`
- all route files listed above
- reusable components under `apps/author-site/components/`
- data/config under `apps/author-site/content/` and `apps/author-site/lib/`
- Supabase migrations under `apps/author-site/supabase/migrations/`
- tests under `apps/author-site/tests/`
- `apps/author-site/.env.example`
- `apps/author-site/README.md`

## Test/build commands
From `apps/author-site/`, run every available command:
