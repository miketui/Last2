...
2. Search for deprecated hex values in `apps/author-site/`.
...
```bash
rg -n "#0E0D0B|#B89968|#1F6F6B|#2B9999|#C9A961" apps/author-site
rg -n "#111111|#B08D57|#D8D1C5|#145B4B|#C7D9D2" apps/author-site/app apps/author-site/components apps/author-site/content apps/author-site/lib
```
Expected:
