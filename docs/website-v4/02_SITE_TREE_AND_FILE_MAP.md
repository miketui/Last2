...
## 1. Purpose
This document defines the professional production file tree for the future Next.js app. Prompt 2 does **not** create the app. Prompt 3 should create `apps/author-site/` exactly as the implementation home unless a newer authoritative app appears.
...
- Do not create `apps/author-site/`.
