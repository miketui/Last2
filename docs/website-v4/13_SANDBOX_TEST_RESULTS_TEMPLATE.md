...
| Security/static | no `.env.local` committed | PASSED | `test ! -f apps/author-site/.env.local` passed. | 2026-06-10 |
| Security/static | no `.env.sandbox` committed | PASSED | `test ! -f apps/author-site/.env.sandbox` passed. | 2026-06-10 |
