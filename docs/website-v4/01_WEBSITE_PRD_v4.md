...
- Audit source: `docs/website-v4/00_REPO_AUDIT.md`.
...
Future app location for Prompt 3: `apps/author-site/`.
...
Prompt 2 acceptance:
- All v4 planning/spec files exist under `docs/website-v4/`.
- No `apps/author-site/` is created.
...
- App scaffolds at `apps/author-site/` only.
...
- `pnpm install`, `pnpm lint`, `pnpm typecheck`, `pnpm test`, and `pnpm build` run from `apps/author-site/` or failures are narrowly documented.
