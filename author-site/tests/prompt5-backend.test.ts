...
describe("Prompt 5 protected downloads", () => {
  ...
  it("uses private bucket paths, never local release/public paths", () => {
    expect(deliverables.epub.path).toBe("books/curls-and-contemplation/epub/Curls-and-Contemplation-v14.1-FULL-CONTENT-KDP-FINAL.epub");
    expect(deliverables.pdf.path).toBe("books/curls-and-contemplation/pdf/Curls-and-Contemplation-v14.1-FULL-CONTENT-POD-Interior-FINAL.pdf");
