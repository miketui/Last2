...
If the requested v14 EPUB path does not exist, report the exact release artifact names and use the newest EPUB confirmed by `release/BUILD-MANIFEST.md` only after explicitly documenting the mismatch.
