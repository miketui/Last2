...
- [ ] Confirm v14 release artifact names and checksums against `release/v14-editorial/EDITORIAL-AND-VALIDATION-REPORT.md`.
...
- [ ] Upload EPUB to `books/curls-and-contemplation/epub/Curls-and-Contemplation-v14-EDITORIAL-KDP-FINAL.epub` and PDF to `books/curls-and-contemplation/pdf/Curls-and-Contemplation-v14-EDITORIAL-POD-Interior-FINAL.pdf` in the private bucket.
