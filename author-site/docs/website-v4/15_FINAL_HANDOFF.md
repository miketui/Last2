...
**Artifact-path refresh:** 2026-07-19. The locked download paths below now target the validated v14.2 zero-truncation release artifacts; production-provider activation remains unchanged.
...
- [ ] Upload EPUB to `books/curls-and-contemplation/epub/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-KDP-FINAL.epub`.
- [ ] Upload PDF to `books/curls-and-contemplation/pdf/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-POD-Interior-FINAL.pdf`.
