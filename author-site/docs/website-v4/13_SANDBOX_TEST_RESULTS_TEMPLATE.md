...
| Supabase Storage | EPUB uploaded to private path | ☐ | `books/curls-and-contemplation/epub/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-KDP-FINAL.epub` |  |  |
| Supabase Storage | PDF uploaded to private path | ☐ | `books/curls-and-contemplation/pdf/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-POD-Interior-FINAL.pdf` |  |  |
