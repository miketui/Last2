...
- EPUB: `release/v14.2-zero-truncation/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-KDP-FINAL.epub`.
- PDF: `release/v14.2-zero-truncation/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-POD-Interior-FINAL.pdf`.
...
- Locked private target paths are `books/curls-and-contemplation/epub/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-KDP-FINAL.epub` and `books/curls-and-contemplation/pdf/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-POD-Interior-FINAL.pdf` in bucket `curls-deliverables`.
...
- Release artifact audit confirmed the locked local artifacts remain under `release/`: `Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-KDP-FINAL.epub` and `Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-POD-Interior-FINAL.pdf`.
