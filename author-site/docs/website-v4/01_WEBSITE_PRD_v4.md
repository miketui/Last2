...
- Current EPUB: `release/v14.2-zero-truncation/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-KDP-FINAL.epub`.
- Current PDF/POD interior: `release/v14.2-zero-truncation/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-POD-Interior-FINAL.pdf`.
...
- File references:
  - EPUB source artifact: `release/v14.2-zero-truncation/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-KDP-FINAL.epub`.
  - PDF source artifact: `release/v14.2-zero-truncation/Curls-and-Contemplation-v14.2-ZERO-TRUNCATION-POD-Interior-FINAL.pdf`.
...
- Release artifact names are normalized to the validated v14.2 zero-truncation artifacts.
