...
- Release artifact: inspect `release/`. The requested v14 path is `/release/v14-editorial/Curls-and-Contemplation-v14-EDITORIAL-KDP-FINAL.epub`; if missing, report the exact mismatch and use the newest confirmed release artifact only as a documented fallback.
