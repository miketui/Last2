...
export async function POST(request: Request) {
  ...
  await recordServerEvent({ eventName: analyticsEvents.bonusClaimSubmitted, route: "/api/bonus-claim", metadata: { databaseConfigured: Boolean(supabase) }, operational: true });
