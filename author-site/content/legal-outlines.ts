export const legalOutlines = {
  ...
  delivery: [
    ...
    "The locked private bucket is curls-deliverables. The locked object paths are the v14.2 EPUB and POD PDF paths documented in the handoff and sandbox runbook.",
