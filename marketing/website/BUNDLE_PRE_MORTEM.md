...
**Run date:** 2026-05-22
**Anchor failure date:** `RELEASE_DATE + 14 days` — the post-mortem window

---

## The thought experiment

> *"It is `RELEASE_DATE + 14 days`. The 90-day pre-order campaign missed its target by 60%. The launch list never crossed 600 subscribers. A wave of refund requests hit in the first week about download issues. Search Console shows two routes de-indexed. The Substack sync silently broke during launch week. Michael is exhausted. What went wrong?"*
...
| **E9** | $17.99 regular (and even the $15.99 pre-order) is a premium over the $9.99 Amazon Kindle edition. The bonus bundle has to carry that gap; if it doesn't, conversion economics may not support paid acquisition. | **Acknowledge:** named. **Assess:** Track. **Decide:** the direct price stays **≥** the Amazon price so Amazon cannot price-match it down. Measure organic-only conversion through T+30 before spending on Meta/Google ads. If the bonus bundle isn't converting, strengthen the bundle before cutting price — do not raise CAC. |
...
- Decision date: during the Phase 0 build — every B-tiger closed before `PREORDER_OPEN`
...
2. **Early in the Phase 0 build:** close B1, B2, B6, B8, B9, B10.
3. **Phase 0 build — commerce block:** close B3, B7.
4. **Phase 0 build — integration block:** close B4, B5.
