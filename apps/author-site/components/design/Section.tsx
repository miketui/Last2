...
export function Section({ eyebrow, title, children, className, quiet = false }: { eyebrow?: string; title?: string; children: ReactNode; className?: string; quiet?: boolean }) {
  const content = (
    <section className={clsx("mx-auto w-full max-w-6xl px-5 py-14 md:px-6 md:py-24", className)}>
